...
from src.expression import ExpInt, Exp, ExpAdd, ExpTimes, Kind, ExpDiv
...
def parse_factor(tokens):
    ...
    if _type == Type.number:
        ...
        back_index()
    # elif _type in [Type.add, Type.sub, Type.times, Type.div]:
    #     val = parse_expr(tokens)
    #     return val
    # else:
    #     raise Exception('parse_factor')
...
def parse(tokens):
    ...
    #         parse_number(t)
    #     elif t.type in [Type.add, Type.sub, Type.times, Type.div]:
    #         parse_operate(t)
    #     else:
    #         raise Exception('unknow token ', t)
    #
    # return True
